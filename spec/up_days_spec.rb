...
describe 'My behaviour' do
  ...
  it 'should increment the sequential counter if the two supplied quotes are up' do
    ...
    expect(@up_days.get_sequential_percentage(@both_ticks_count, @first_tick_count)).to equal(100)
  ...
  it 'should not increment the counter if the first quote is down but the second quote is up' do
    ...
    expect(@up_days.get_sequential_percentage(@both_ticks_count, @first_tick_count)).to equal(0)
  end
end
