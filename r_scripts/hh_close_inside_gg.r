...
geom_point(aes(y = pips)) + geom_line(aes(y = pc.50, colour = 'Median')) +
geom_line(aes(y = pc.80, colour = '80')) + geom_line(aes(y = pc.20, colour = '20')) +
theme_solarized() + ggtitle("Break size where we close back inside")
